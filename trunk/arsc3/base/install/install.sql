...
INSERT INTO `arsc_parameters` VALUES ('ping', '60', 'This value defines after how many seconds a user will be logged out (because he closed his browser window without using the "Exit" link in the chat).');
