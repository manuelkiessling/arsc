...
INSERT INTO `arsc_parameters` VALUES ('rowlimit', '4', 'This value defines how many entries will be hold in the database table of each room at the most. This is used to avoid an unlimited grow of the database tables, which would slow things down. Set this higher if you have really many users chatting at the same time.');
