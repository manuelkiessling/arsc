     ...
     <td>
      ...
      <form action="login.php" METHOD="POST">
       ...
       if ($arsc_parameters["show_version_selection"] == "yes")
       {
        ?>
        <center>
        <table width="80%" bgcolor="<?php echo $arsc_parameters["color_roomlist_window_foreground"]; ?>" align="center">
         <tr>
          <td>
           <font face="Arial" size="2">
            <b>
      ...
      <?php
       ...
       if ($arsc_b["howmany"] > 0)
       {
        ...
        <table width="100%" align="center">
         <tr bgcolor="<?php echo $arsc_parameters["color_roomlist_window_foreground"]; ?>">
          <td width="40%">
           <font face="Arial" size="2">
