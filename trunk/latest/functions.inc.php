...
$arsc_parameters["htmlhead_out"] = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\" \"http://www.w3.org/TR/REC-html40/loose.dtd\"><html><head><title>You are out!</title></head><body bgcolor=\"".$arsc_color["standard_window_background"]."\"></body></html>";

// The HTML head for the message input page
$arsc_parameters["htmlhead_msginput"] = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\" \"http://www.w3.org/TR/REC-html40/loose.dtd\"><html><head><title>Message Input</title></head><body bgcolor=\"".$arsc_color["msginput_window_background"]."\" link=\"".$arsc_color["msginput_window_link"]."\">";
